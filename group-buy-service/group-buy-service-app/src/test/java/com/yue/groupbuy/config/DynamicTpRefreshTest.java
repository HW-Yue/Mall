...
class DynamicTpRefreshTest {
    ...
    void shouldRefreshBusinessExecutorAndTomcatExecutor() {
        ...
        DtpExecutor executor = new DtpExecutor(5, 10, 60, TimeUnit.SECONDS, new LinkedBlockingQueue<>());
        executor.setThreadPoolName("threadPoolExecutor");
        executor.setThreadPoolAliasName("group-buy-business");
        ...
        executorProps.setCorePoolSize(7);
        executorProps.setMaximumPoolSize(14);
        ...
        assertEquals(7, executor.getCorePoolSize());
        assertEquals(14, executor.getMaximumPoolSize());
        ...
        org.apache.tomcat.util.threads.ThreadPoolExecutor tomcatExecutor =
                new org.apache.tomcat.util.threads.ThreadPoolExecutor(
                        10, 20, 60, TimeUnit.SECONDS, new TaskQueue(100));
        ...
        tomcatTp.setCorePoolSize(12);
        tomcatTp.setMaximumPoolSize(24);
        ...
        assertEquals(12, tomcatExecutor.getCorePoolSize());
        assertEquals(24, tomcatExecutor.getMaximumPoolSize());
    ...
    private static void printDtpState(String phase, DtpExecutor executor) {
        System.out.printf("[DynamicTpRefreshTest-group-buy] phase=%s dtpCore=%d dtpMax=%d dtpKeepAlive=%d%n",
    ...
    private static void printTomcatState(String phase, org.apache.tomcat.util.threads.ThreadPoolExecutor executor) {
        System.out.printf("[DynamicTpRefreshTest-group-buy] phase=%s tomcatCore=%d tomcatMax=%d tomcatKeepAlive=%d%n",
                phase, executor.getCorePoolSize(), executor.getMaximumPoolSize(),
                executor.getKeepAliveTime(TimeUnit.SECONDS));
    }
