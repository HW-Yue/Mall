...
public class OrderRepository implements IOrderRepository {
    ...
    @Override
    public void doSaveOrder(CreateOrderEntity createOrderEntity) {

        PayOrder order = new PayOrder();
        order.setUserId(createOrderEntity.getUserId());
        order.setProductId(createOrderEntity.getProductId());
        order.setProductName(createOrderEntity.getProductName());
        order.setOrderId(createOrderEntity.getOrderId());
        order.setOrderTime(new Date());
        order.setTotalAmount(createOrderEntity.getOriginalPrice());
        order.setStatus(OrderStatusVO.CREATE.getCode());
        order.setMarketType(MarketTypeVO.Normal.getCode());
        order.setMarketDeductionAmount(BigDecimal.ZERO);
        order.setPayAmount(createOrderEntity.getPayPrice());
        order.setMarketType(createOrderEntity.getMarketTypeVO().getCode());
