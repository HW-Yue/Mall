...
启动：
  python locust/mock/alipay.py
  PORT=7000 NOTIFY_URL=http://localhost:9091/api/v1/alipay/alipay_notify_url python locust/mock/alipay.py
"""
import os
import sys
import threading
