...
export const API_ENDPOINTS = {
  ...
  AI_CLIENT: {
    ...
    /** 根据 client_type 查询客户端实例列表 */
    QUERY_BY_CLIENT_TYPE: '/query-by-client-type',
  },
  ...
  AI_AGENT_DRAW: {
    ...
    /** 根据策略获取允许的 client_type 槽位列表 */
    CLIENT_TYPES_BY_STRATEGY: '/client-types-by-strategy',
  },
  ...
  ADMIN_USER: {
    ...
    // 可选：如果后端实现了退出登录接口，可直接复用
    // LOGOUT: '/logout',
  },

  // 计费/资产相关接口
  FINANCE: {
    BASE: `${API_CONFIG.BASE_DOMAIN}/api/${API_CONFIG.API_VERSION}/finance`,
