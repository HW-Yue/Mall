...
| `pay` | `order-close-group-buy` | `pay`、`order-service` | `CG_PAY_ORDER_CLOSE_GROUP_BUY`、`CG_ORDER_CLOSE_GROUP_BUY` | 普通 | [order-close-group-buy](./topics/order-close-group-buy.md) |
| `pay` | `order-close-seckill` | `pay`、`order-service` | `CG_PAY_ORDER_CLOSE_SECKILL`、`CG_ORDER_CLOSE_SECKILL` | 普通 | [order-close-seckill](./topics/order-close-seckill.md) |
...
| `order-service` | `order-close-group-buy` | `pay`、`order-service` | `CG_PAY_ORDER_CLOSE_GROUP_BUY`、`CG_ORDER_CLOSE_GROUP_BUY` | 普通 | [order-close-group-buy](./topics/order-close-group-buy.md) |
| `order-service` | `order-close-seckill` | `pay`、`order-service` | `CG_PAY_ORDER_CLOSE_SECKILL`、`CG_ORDER_CLOSE_SECKILL` | 普通 | [order-close-seckill](./topics/order-close-seckill.md) |
| `order-service` | `order-close-group-buy-market` | `group-buy-service` | `CG_GROUP_BUY_ORDER_CLOSE` | 普通 | [order-close-group-buy-market](./topics/order-close-group-buy-market.md) |
| `order-service` | `order-close-seckill-market` | `seckill-service` | `CG_ORDER_CLOSE_SECKILL_MARKET` | 普通 | [order-close-seckill-market](./topics/order-close-seckill-market.md) |
| `order-service` | `pay-refund-normal` | `pay` | `CG_PAY_PAY_REFUND_NORMAL` | 事务消息 | [pay-refund-normal](./topics/pay-refund-normal.md) |
| `order-service` | `pay-refund-group-buy` | `pay` | `CG_PAY_PAY_REFUND_GROUP_BUY` | 事务消息 | [pay-refund-group-buy](./topics/pay-refund-group-buy.md) |
| `order-service` | `pay-refund-seckill` | `pay` | `CG_PAY_PAY_REFUND_SECKILL` | 事务消息 | [pay-refund-seckill](./topics/pay-refund-seckill.md) |
| `order-service` | `order-refund-group-buy` | `group-buy-service` | `CG_GROUP_BUY_PAY_REFUND` | 普通 | [order-refund-group-buy](./topics/order-refund-group-buy.md) |
| `order-service` | `order-refund-seckill` | `seckill-service` | `CG_SECKILL_PAY_REFUND` | 普通 | [order-refund-seckill](./topics/order-refund-seckill.md) |
...
| `order-service` | `order-close-group-buy` | `pay`、`order-service` | `CG_ORDER_CLOSE_GROUP_BUY` | `OrderCloseGroupBuyListener` | [order-close-group-buy](./topics/order-close-group-buy.md) |
...
| `group-buy-service` | `order-close-group-buy-market` | `order-service` | `CG_GROUP_BUY_ORDER_CLOSE` | `OrderCloseGroupBuyListener` | [order-close-group-buy-market](./topics/order-close-group-buy-market.md) |
| `group-buy-service` | `order-refund-group-buy` | `order-service` | `CG_GROUP_BUY_PAY_REFUND` | `PayRefundGroupBuyListener` | [order-refund-group-buy](./topics/order-refund-group-buy.md) |
...
| `seckill-service` | `order-close-seckill-market` | `order-service` | `CG_ORDER_CLOSE_SECKILL_MARKET` | `OrderCloseSeckillListener` | [order-close-seckill-market](./topics/order-close-seckill-market.md) |
| `seckill-service` | `order-refund-seckill` | `order-service` | `CG_SECKILL_PAY_REFUND` | `PayRefundSeckillListener` | [order-refund-seckill](./topics/order-refund-seckill.md) |
...
| `pay` | `order-close-group-buy` | `pay`、`order-service` | `CG_PAY_ORDER_CLOSE_GROUP_BUY` | `OrderCloseGroupBuyListener` | [order-close-group-buy](./topics/order-close-group-buy.md) |
...
| `pay` | `pay-refund-group-buy` | `order-service` | `CG_PAY_PAY_REFUND_GROUP_BUY` | `PayRefundGroupBuyListener` | [pay-refund-group-buy](./topics/pay-refund-group-buy.md) |
...
- 当前统一约束：`outTradeNo` 只允许存在于 `order-service` 与 `pay-service` 之间；营销服务 topic 只能透传 `orderId`
