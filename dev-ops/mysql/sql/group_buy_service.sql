...
VALUES
  ...
  ('25120209', '企业套餐直减50', '企业知识库套餐拼团立减50元', 0, 'ZJ', '50', NULL),
  ('25120210', '训练额度直减80', '模型训练额度拼团立减80元', 0, 'ZJ', '80', NULL);
...
VALUES
  ...
  (100125, '企业知识库拼团活动', '25120209', 1, 2, 4, 30, 1, NOW(), DATE_ADD(NOW(), INTERVAL 1 YEAR), NULL, NULL),
  (100126, '训练额度拼团活动', '25120210', 1, 1, 5, 45, 1, NOW(), DATE_ADD(NOW(), INTERVAL 1 YEAR), NULL, NULL);
...
VALUES
  ...
  ('s01', 'c01', 100125, 'group_buy', '3001'),
  ('s01', 'c01', 100125, 'group_buy', '3002'),
  ('s01', 'c01', 100125, 'group_buy', '3003'),
  ('s01', 'c01', 100126, 'group_buy', '4001'),
  ('s01', 'c01', 100126, 'group_buy', '4002'),
  ('s01', 'c01', 100126, 'group_buy', '4003');
...
INSERT INTO `team_order` (
  ...
  ('TGB30001', 100125, 's01', 'c01', 399.00, 50.00, 349.00, 4, 2, 2, 0, '2026-04-25 14:00:00', '2026-04-25 14:30:00', 'MQ', NULL),
  ('TGB30002', 100125, 's01', 'c01', 699.00, 50.00, 649.00, 4, 4, 0, 1, '2026-04-26 16:00:00', '2026-04-26 16:30:00', 'MQ', NULL),
  ('TGB40001', 100126, 's01', 'c01', 999.00, 80.00, 919.00, 5, 3, 1, 0, '2026-04-27 19:00:00', '2026-04-27 19:45:00', 'MQ', NULL);

INSERT INTO `t_order` (
  `order_id`, `user_id`, `team_id`, `activity_id`, `goods_id`, `status`,
  `original_price`, `deduction_price`, `pay_price`, `out_trade_time`, `start_time`, `end_time`
) VALUES
  -- 已成团 TGB10001（3 人全支付）
  ('901300100001', 'xfg01',  'TGB10001', 100123, '1001', 1, 199.00, 20.00, 179.00, '2026-04-18 10:02:00', '2026-04-18 10:00:00', '2026-04-18 10:20:00'),
  ('901300100002', 'xfg02',  'TGB10001', 100123, '1001', 1, 199.00, 20.00, 179.00, '2026-04-18 10:04:00', '2026-04-18 10:00:00', '2026-04-18 10:20:00'),
  ('901300100003', 'xiaofuge','TGB10001', 100123, '1001', 1, 199.00, 20.00, 179.00, '2026-04-18 10:05:00', '2026-04-18 10:00:00', '2026-04-18 10:20:00'),
  -- 拼团中 TGB10002（1 人付、2 人锁单）
  ('901300200001', 'xfg04',  'TGB10002', 100123, '1003', 1, 159.00, 20.00, 139.00, '2026-04-22 12:01:00', '2026-04-22 12:00:00', '2026-04-22 12:20:00'),
  ('901300200002', 'xfg05',  'TGB10002', 100123, '1003', 0, 159.00, 20.00, 139.00, NULL,            '2026-04-22 12:00:00', '2026-04-22 12:20:00'),
  ('901300200003', 'xfg06',  'TGB10002', 100123, '1003', 0, 159.00, 20.00, 139.00, NULL,            '2026-04-22 12:00:00', '2026-04-22 12:20:00'),
  -- 存储拼团 2 人成团
  ...
  -- 企业知识库拼团中 TGB30001（2 人付、2 人锁单）
  ('901300400001', 'corp01', 'TGB30001', 100125, '3001', '200000000030', 1, 399.00, 50.00, 349.00, '2026-04-25 14:02:00', '2026-04-25 14:00:00', '2026-04-25 14:30:00'),
  ('901300400002', 'corp02', 'TGB30001', 100125, '3001', '200000000031', 1, 399.00, 50.00, 349.00, '2026-04-25 14:05:00', '2026-04-25 14:00:00', '2026-04-25 14:30:00'),
  ('901300400003', 'corp03', 'TGB30001', 100125, '3001', '200000000032', 0, 399.00, 50.00, 349.00, NULL,             '2026-04-25 14:00:00', '2026-04-25 14:30:00'),
  ('901300400004', 'corp04', 'TGB30001', 100125, '3001', '200000000033', 0, 399.00, 50.00, 349.00, NULL,             '2026-04-25 14:00:00', '2026-04-25 14:30:00'),
  -- 企业知识库拼团已成团 TGB30002（4 人全支付）
  ('901300500001', 'corp11', 'TGB30002', 100125, '3002', '200000000040', 1, 699.00, 50.00, 649.00, '2026-04-26 16:02:00', '2026-04-26 16:00:00', '2026-04-26 16:30:00'),
  ('901300500002', 'corp12', 'TGB30002', 100125, '3002', '200000000041', 1, 699.00, 50.00, 649.00, '2026-04-26 16:03:00', '2026-04-26 16:00:00', '2026-04-26 16:30:00'),
  ('901300500003', 'corp13', 'TGB30002', 100125, '3002', '200000000042', 1, 699.00, 50.00, 649.00, '2026-04-26 16:06:00', '2026-04-26 16:00:00', '2026-04-26 16:30:00'),
  ('901300500004', 'corp14', 'TGB30002', 100125, '3002', '200000000043', 1, 699.00, 50.00, 649.00, '2026-04-26 16:09:00', '2026-04-26 16:00:00', '2026-04-26 16:30:00'),
  -- 训练额度拼团中 TGB40001（3 人付、1 人锁单）
  ('901300600001', 'train01','TGB40001', 100126, '4001', '200000000050', 1, 999.00, 80.00, 919.00, '2026-04-27 19:02:00', '2026-04-27 19:00:00', '2026-04-27 19:45:00'),
  ('901300600002', 'train02','TGB40001', 100126, '4001', '200000000051', 1, 999.00, 80.00, 919.00, '2026-04-27 19:05:00', '2026-04-27 19:00:00', '2026-04-27 19:45:00'),
  ('901300600003', 'train03','TGB40001', 100126, '4001', '200000000052', 1, 999.00, 80.00, 919.00, '2026-04-27 19:07:00', '2026-04-27 19:00:00', '2026-04-27 19:45:00'),
  ('901300600004', 'train04','TGB40001', 100126, '4001', '200000000053', 0, 999.00, 80.00, 919.00, NULL,             '2026-04-27 19:00:00', '2026-04-27 19:45:00');
...
INSERT INTO `notify_task` (
  ...
  (100125, 'TGB30002', 'GROUP_COMPLETE', 'MQ', 'group_settle', NULL, 1, 1, '{"team_id":"TGB30002","activity_id":100125}', 'uuid-tgb30002-001'),
  (100126, 'TGB40001', 'GROUP_PENDING',  'MQ', 'group_progress', NULL, 0, 0, '{"team_id":"TGB40001","activity_id":100126}', 'uuid-tgb40001-001');
...
VALUES
  (1, 'AI模型',   'ai_model'),
  (2, '存储资源', 'storage'),
  (3, '企业知识库', 'knowledge_base'),
  (4, '训练额度', 'training_credit');
...
VALUES
  ('1001', 'GPT-4 100万Token',      'https://cdn.nexus.local/group-buy/gpt4-100w.png', '适合通用问答、内容生成与业务自动化的高质量模型额度包。', 199.00, 1),
  ('1003', 'Claude 100万Token',     'https://cdn.nexus.local/group-buy/claude-100w.png', '偏长文本理解与总结场景的模型额度包，适合知识处理与审阅。', 159.00, 1),
  ('1005', '通义千问 100万Token',   'https://cdn.nexus.local/group-buy/qwen-100w.png', '面向中文业务场景的基础模型额度包，适合企业内部应用接入。',  89.00, 1),
  ('2002', '云存储 200MB',          'https://cdn.nexus.local/group-buy/storage-200mb.png', '轻量文档和素材托管空间，适合个人试用。',  18.00, 2),
  ('2004', '云存储 1GB',            'https://cdn.nexus.local/group-buy/storage-1gb.png', '适合中小型知识库与附件托管的基础存储包。',  69.00, 2),
  ('2005', '云存储 1TB',            'https://cdn.nexus.local/group-buy/storage-1tb.png', '适合长期归档、多团队共享与海量文件场景的大容量存储包。', 299.00, 2),
  ('3001', '企业知识库入门版',       'https://cdn.nexus.local/group-buy/kb-starter.png', '适合 20 人以内团队的知识库方案，包含检索、权限和基础问答能力。', 399.00, 3),
  ('3002', '企业知识库专业版',       'https://cdn.nexus.local/group-buy/kb-pro.png', '适合跨部门协作的专业知识库方案，支持更多索引容量和工作流接入。', 699.00, 3),
  ('3003', '企业知识库旗舰版',       'https://cdn.nexus.local/group-buy/kb-enterprise.png', '面向大型组织的高并发知识管理方案，支持审计、隔离与多空间管理。', 1299.00, 3),
  ('4001', '模型训练额度 500 次',    'https://cdn.nexus.local/group-buy/train-500.png', '适合轻量微调与实验验证的训练额度包。', 999.00, 4),
  ('4002', '模型训练额度 2000 次',   'https://cdn.nexus.local/group-buy/train-2000.png', '适合稳定迭代的训练额度包，覆盖多轮实验与回归。', 2999.00, 4),
  ('4003', '模型训练额度 10000 次',  'https://cdn.nexus.local/group-buy/train-10000.png', '适合生产前强化训练与批量调优的高阶额度包。', 9999.00, 4);
...
VALUES
  ...
  ('3001', 'knowledge_docs', '5000', 'doc'),
  ('3002', 'knowledge_docs', '20000', 'doc'),
  ('3003', 'knowledge_docs', '100000', 'doc'),
  ('4001', 'training_runs', '500', 'run'),
  ('4002', 'training_runs', '2000', 'run'),
  ('4003', 'training_runs', '10000', 'run');
